...
const WrappedCarousel = ({ text, images }) => {
    return (
        <div className="relative w-full min-h-[300px] bg-gray-100 rounded-lg shadow-md overflow-hidden">
            <div className="absolute top-2 left-2  text-gray-800 text-lg font-semibold px-4 py-2 rounded-lg shadow">
                {text}
            </div>
