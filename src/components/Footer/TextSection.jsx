    ...
    const footerText = [
        ...
        },
        {
          ...
          content: [
            ...
            "Electronic Devices and Accessories: When it comes to laptops, we are not far behind. Filter among dozens of super-fast operating systems, hard disk capacity, RAM, lifestyle, screen size and many other criteria for personalized results in a flash. All you students out there, confused about what laptop to get? Our Back To College Store segregates laptops purpose wise (gaming, browsing and research, project work, entertainment, design, multitasking) with recommendations from top brands and industry experts, facilitating a shopping experience that is quicker and simpler.",
        ...
        {
          title: "Books, Sports and More",
          content: [
            "From bestsellers to classics, you will find all kinds of books at the best prices here. If you're into running, yoga, training, or any other sports, find all the gear you need here. You can find bags from brands like Wildcraft, Adidas, Nike, Fastrack, Skybags, and American Tourister. Moreover, you can choose from a wide range of brands like Puma, Sketchers, and so on. Considered taking up a sport? From basketball to badminton, cycling to running, you will find the best of sports products here. Check out our range of sports and fitness equipment and gear up to be your best self."
          ]
        },
        {
